  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50 text-slate-600">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <StaggerContainer className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4" stagger={0.1} amount={0.05}>
        ...
        {/* Bottom Bar */}
        <AnimatedSection delay={0.2} className="mt-12 border-t border-slate-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>
