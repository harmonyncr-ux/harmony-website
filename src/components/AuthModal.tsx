...
import { X, ShieldAlert, GraduationCap, Loader2 } from "lucide-react";
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="pt-2 pb-1">
              <button
                ...
                className="group relative flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white py-3.5 px-4 text-xs font-bold text-slate-800 shadow-md hover:border-[#5850ec]/50 hover:bg-slate-50 hover:shadow-lg active:scale-[0.99] disabled:opacity-60 disabled:pointer-events-none transition-all"
              >
                {isSigningIn ? (
