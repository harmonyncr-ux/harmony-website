    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 space-y-10 bg-[#f8fafc]">
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3, 4, 5, 6].map((idx) => (
              <div key={idx} className="h-64 rounded-3xl border border-slate-200 bg-white p-6 shadow-md animate-pulse space-y-4">
                <div className="h-4 w-24 animate-shimmer rounded-full" />
          ...
          /* Competitions Grid — Equal Height Items */
              ...
              return (
                <StaggerItem key={c.id} className="h-full flex">
                  <motion.div
                    ...
                    className={`group flex flex-col justify-between w-full h-full rounded-3xl border bg-white p-6 shadow-lg transition-all hover:shadow-xl space-y-4 ${
                      isExpired
